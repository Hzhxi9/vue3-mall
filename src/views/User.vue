  ...
  <div>
    ...
    <van-form @submit="submit">
      ...
      <div class="footer-btn">
        ...
        <van-button round block color="#1baeae" @click="logout"> 退出登录 </van-button>
      </div>
    </van-form>
  </div>
</template>
...
import { editUserInfo, getUserInfo, logout } from "../api/api";
...
export default {
  ...
  setup() {
    ...
    onMounted(async () => {
      const { nickName, introduceSign } = await getUserInfo();
