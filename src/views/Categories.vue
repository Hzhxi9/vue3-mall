...
<div class="warp">
    ...
    <main>
        <van-sidebar v-model="activeKey" :style="{ width: '120px', height: '100%' }">
            <van-sidebar-item v-for="e in categories" :key="e.categoryId" :title="e.categoryName" @click="changeCategory" />
        </van-sidebar>
        <div class="categories">
            <CategoriesListComp v-for="e in categoriesList" :key="e.categoryId" :list="e" />
        </div>
    </main>
    <NavBarComp />
</div>
